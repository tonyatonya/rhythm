		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 bottomfooter">
				...
				<ul class="foot-icon">
					...
					<li><a href="#"><img src="images/inniicon.png" alt="inniicon" width="50" height="38" /></a></li>
					<li><a href="#"><img src="images/rythmicon.png" alt="rythmicon" width="89" height="21" /></a></li>
				</ul>
			</div>
		</div>
	</div>
